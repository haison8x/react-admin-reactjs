...
import { Product } from '#entity/retail';
...
export class ProductService {
  constructor(
    ...
    private table: Repository<Product>,
  ...
  public async update(id: number, data: Partial<Product>): Promise<UpdateResult> {
  ...
  public async readMany(retailQuery: RetailQuery): Promise<Product[]> {
